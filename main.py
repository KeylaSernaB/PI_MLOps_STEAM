...
@app.get("/")
async def root():
    return {"Mensaje": "Bienvenidos a mi PI KEYLA"}
...
async def user(genero: str):
    ...
    try:
        ...
        df_genero = pd.read_csv("Api/PlayTimeGenre.csv")
...
async def user(genero: str):
    ...
    try:
        ...
        df_usuario_por_genero = pd.read_csv("Api/UserForGenre.csv")
...
async def user(año: int):
    ...
    try:
        ...
        recomendaciones_anio = pd.read_csv("Api/UsersRecommend.csv")
...
async def Users(año: int):
    ...
    try:
        ...
        recomendaciones = pd.read_csv("Api/UsersWorstDeveloper.csv")
...
async def user(developer: str):
    ...
    try:
        # Cargar el DataFrame desde el archivo CSV
        analisis_sentimientos_df = pd.read_csv("Api/sentiment_analysis.csv")
